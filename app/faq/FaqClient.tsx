      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 14 }}>
          <div style={{ background: '#f8fafc', borderRadius: 12, padding: 18, border: '1px solid #e8eef5' }}>
            ...
            <ul style={{ fontSize: '.85rem', color: '#4a6580', lineHeight: 2.2, paddingRight: 20, margin: 0 }}>
              <li>لا يوجد ضمان قبول</li>
              <li> الرسوم غير قابلة للاسترداد</li>
              <li> القرار يعود للجهة المانحة</li>
              <li> عملية تنافسية مع آلاف الطلاب</li>
              <li> نقدم الدعم في تجهيز الملف فقط</li>
            </ul>
          </div>
          <div style={{ background: '#e8f5e9', borderRadius: 12, padding: 18, border: '1px solid #4CAF50' }}>
            ...
            <ul style={{ fontSize: '.85rem', color: '#1b5e20', lineHeight: 2.2, paddingRight: 20, margin: 0 }}>
              <li> ضمان قبول 100%</li>
              <li> استرداد كامل في حال الرفض</li>
              <li> القرار مضمون من الجامعة</li>
              <li> عملية سريعة ومباشرة</li>
              <li> إشراف كامل من فريقنا</li>
            </ul>
          </div>
        </div>
  ...
  return (
    <div className={`faq-card ${open ? 'open' : ''}`} onClick={() => setOpen(o => !o)}>
      <div className="faq-head">
        ...
        <div className={`faq-arrow ${open ? 'rotated' : ''}`}>
          <ChevronDown size={18} />
        </div>
      </div>
      {open && (
...
export default function FaqClient() {
  ...
  return (
    <div className="faq-page">
      ...
      {/* HERO */}
      <section className="faq-hero  mt-10">
        ...
        <div className="faq-hero-stats">
          <div style={{ textAlign: 'center' }}>
            <div className="faq-hero-stat-num"><span>{FAQ_ITEMS.length}</span></div>
            <div className="faq-hero-stat-label">سؤال شائع</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div className="faq-hero-stat-num"><span>24</span>h</div>
            <div className="faq-hero-stat-label">وقت الرد</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div className="faq-hero-stat-num"><span>مجاناً</span></div>
            <div className="faq-hero-stat-label">الاستشارة الأولى</div>
          </div>
        </div>
      </section>
